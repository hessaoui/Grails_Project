...
%{--                <g:each in="annonce" var="anc">--}%
                        ...
                        <div class="property-value" aria-labelledby="illustrations-label">
                            <ul>
                                <g:each in="${annonce.illustrations}" var="${illus}">
                                        <li>
                                            <g:link controller="illustration" active="show" id="${illus.id}">
                                                <asset:image src="${illus.filename}"></asset:image>
                                            </g:link>
                                        </li>
                                </g:each>
                            </ul>
                    ...
                    <li class="fieldcontain">
                        ...
                        <div class="property-value" aria-labelledby="author-label"><a href="/user/show/3">${annonce.author.username}</a></div>
                    </li>
%{--                </g:each>--}%
