            ...
            <g:form resource="${this.user}" method="POST">
                <fieldset class="form">
                    ...
                    <div class="fieldcontain">
                        <label for="tel">Tel</label><input type="text" name="tel" value="" maxlength="16" id="tel">
                    </div>
                    <div class="fieldcontain required">
                    ...
                    <div class="fieldcontain required">
                        ...
                        <g:select name="role" from="${project1.Role.list()}" optionValue="authority" noSelection="['null':'Choose role']" optionKey="id" id="role"/>
                    </div>
                    <div class="fieldcontain">
                    ...
                    <div class="fieldcontain">
                        ...
                        <ul></ul>
                        <a href="/annonce/create?user.id=">Add Annonce</a>
                    </div>
                </fieldset>
